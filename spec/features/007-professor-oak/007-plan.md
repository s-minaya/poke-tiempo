...
- **Personalidad (`scripts/oak/oak-prompt.ts`):** el prompt es prosa y vive aparte del transporte. Character bible del personaje, qué significa cada uno de los cinco tonos y una dirección editorial por leitmotiv. Al no quedarle ninguna decisión factual al proveedor, todo el encargo es de voz.
